<p align="center">
  <img src="https://img.shields.io/badge/supplychain:npm-hardened-green?style=flat-square" alt="npm" />
...
<p align="center">
  ...
  Protects the npm supply chain across npm, pnpm, and Yarn v2+ — at the project level and in GitHub Actions CI.
</p>
...
|---------|------------------|
| `/supplychain:npm-harden` | Audits the current project's package manager config and outputs a prioritised fix list (CRITICAL → HARDENING → PASSING) |
| `/supplychain:npm-harden ./apps/web` | Same, against a specific project root |
| `/supplychain:npm-ci-audit` | Audits how npm/pnpm/Yarn is invoked in `.github/workflows/**` — install flags, registry override, manager version drift, OIDC publish, `npx` surface, plus generic Actions hardening |
| `/supplychain:npm-ci-audit ./repo` | Same, against a specific repo root |
